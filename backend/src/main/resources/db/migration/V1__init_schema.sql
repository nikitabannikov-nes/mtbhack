...
CREATE TABLE bonus_templates (
    ...
    value_min           DECIMAL(8,2) NOT NULL DEFAULT 0.00,
    value_max           DECIMAL(8,2) NOT NULL DEFAULT 0.00,
    unit                VARCHAR(20) NOT NULL DEFAULT 'NONE',
    timer_min_days      INT NOT NULL DEFAULT 1,
    timer_max_days      INT NOT NULL DEFAULT 3,
